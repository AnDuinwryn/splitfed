...
#   N_LOCAL_STAGE2=5
#   BATCH_SIZE=256
#   STATIC_FEATURE_SOURCE=auto   # none | auto | mel | opensmile | parselmouth
...
N_GLOBAL_STAGE1="${N_GLOBAL_STAGE1:-64}"
N_GLOBAL_STAGE2="${N_GLOBAL_STAGE2:-64}"
N_LOCAL_STAGE1="${N_LOCAL_STAGE1:-5}"
N_LOCAL_STAGE2="${N_LOCAL_STAGE2:-5}"
BATCH_SIZE="${BATCH_SIZE:-256}"
STATIC_FEATURE_SOURCE="${STATIC_FEATURE_SOURCE:-auto}"
